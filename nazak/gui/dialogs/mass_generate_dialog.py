...
class MassGenerateDialog(QDialog):
    def __init__(self, profile_manager, parent=None):
        ...
        self.setWindowTitle("Bulk Profile Generation")
        self.resize(680, 580)
    ...
    def init_ui(self):
        ...
        # Title & Subtitle
        lbl_title = QLabel("Bulk Creation of Isolated Profiles", self)
        lbl_title.setStyleSheet("color: #ffffff; font-size: 18px; font-weight: 700;")
        main_layout.addWidget(lbl_title)

        lbl_desc = QLabel(
            "Instantly create a profile farm with unique GPU, CPU, RAM, Audio/Canvas noise, and proxy distribution.",
            self,
        )
        ...
        # Count Slider
        lbl_c = QLabel("Number of profiles:", card_base)
        ...
        self.lbl_count_val = QLabel("10 profiles", card_base)
        ...
        # Group Name
        lbl_g = QLabel("Profile group:", card_base)
        ...
        self.combo_os.addItem("Mixed (Win + Mac + Linux)", userData="all")
        grid.addWidget(self.combo_os, 2, 1)

        # Target Start Page
        lbl_page = QLabel("Start page:", card_base)
        lbl_page.setStyleSheet("color: #d4d4d8; font-size: 12px;")
        grid.addWidget(lbl_page, 3, 0)

        self.combo_page = ComboBox(card_base)
        self.combo_page.addItem("Google Login", userData="google_login")
        self.combo_page.addItem("YouTube Studio", userData="youtube_studio")
        self.combo_page.addItem("Google Ads (Dashboard)", userData="google_ads")
        self.combo_page.addItem("Google Search", userData="google_search")
        ...
        lbl_p_title = QLabel("Proxy list (one line per profile, assigned round-robin):", card_proxy)
        ...
        self.btn_generate = PrimaryPushButton(FluentIcon.ADD, "Generate Profiles", self)
    ...
    def on_slider_changed(self, val):
        self.lbl_count_val.setText(f"{val} profiles")
    ...
    def on_generate_profiles(self):
        ...
        InfoBar.success(
            ...
            f"Generated {len(created)} new isolated profiles!",
            parent=self,
