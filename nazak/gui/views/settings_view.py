...
from qfluentwidgets import (
    SimpleCardWidget, ComboBox, PushButton, setTheme, Theme, InfoBar, InfoBarPosition, FluentIcon
)
...
class SettingsView(QWidget):
    ...
    def on_theme_changed(self):
        ...
        if theme is not None:
            setTheme(theme)
            InfoBar.success("Тема обновлена", "Оформление интерфейса изменено", parent=self, position=InfoBarPosition.TOP)
