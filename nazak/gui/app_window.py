...
class NazakFluentMainWindow(MSFluentWindow):
    ...
    def init_window(self):
        self.setWindowTitle("Nazak Browser Studio")
    ...
    def init_navigation(self):
        ...
        self.addSubInterface(
            self.profiles_view, FluentIcon.APPLICATION, "Profiles", FluentIcon.APPLICATION, NavigationItemPosition.TOP
        )

        # 2. YouTube Shorts Autoposter
        self.autopost_view = AutopostView(self.profile_manager, self.browser_launcher, self)
        self.addSubInterface(
            self.autopost_view, FluentIcon.SEND, "Autoposting", FluentIcon.SEND, NavigationItemPosition.TOP
        )
        ...
        self.addSubInterface(
            self.accounts_view, FluentIcon.PEOPLE, "Accounts", FluentIcon.PEOPLE, NavigationItemPosition.TOP
        )

        # 4. Proxies & Bulk Import
        self.proxies_view = ProxiesView(self.profile_manager, self.browser_launcher, self)
        self.addSubInterface(
            self.proxies_view, FluentIcon.GLOBE, "Proxies", FluentIcon.GLOBE, NavigationItemPosition.TOP
        )
        ...
        self.addSubInterface(
            self.settings_view, FluentIcon.SETTING, "Settings", FluentIcon.SETTING, NavigationItemPosition.BOTTOM
        )
